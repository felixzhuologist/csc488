...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Feb 21 16:07:46 EST 2017
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		Type t = (Type)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
			RESULT = new ScalarDecl((Type)t, i); 
		...
		DeclarationPart v = (DeclarationPart)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
			RESULT = vs.addLast(v);  // ps is an ASTList of ScalarDecl
		...
		Scope s = (Scope)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
			...
			RESULT = new RoutineDecl(i, t, routineBody); 
